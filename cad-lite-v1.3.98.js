   (function(){
    ...
    window.addEventListener('keydown', (e) => {
      ...
      function openKeyboardShortcuts(){
        ...
        foot.innerHTML='<strong>Tool tip:</strong> S, R, and O are momentary while held. The Inspector buttons can lock Splash and Radius modes on; <kbd>Enter</kbd> or a blank-canvas click exits them.';
