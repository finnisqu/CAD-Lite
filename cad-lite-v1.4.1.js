   (function(){
    function init(){
      ...
      function planCanvasSize(plan){
        ...
        return {
          w:Math.max(12,Math.ceil((plan.w*c+plan.h*s)*1000)/1000),
          h:Math.max(12,Math.ceil((plan.w*s+plan.h*c)*1000)/1000)
        };
      }
      ...
      function drawPlanUnderlay(){
        ...
        const x=(state.cw-plan.w)/2;
        const y=(state.ch-plan.h)/2;
      ...
      function ensurePlanNavigatorCard(){
        ...
        card.className='lc-card lc-plan-card';
      ...
      function renderPlanNavigator(){
        ...
        geometry.append(geoTitle,size,buttons);
      ...
      const shortcutGroups=[
        {
          ...
          rows:[
            ...
            {keys:[['Hold O']],action:'Grab / move slab overlay',context:'SLAB'}
          ]
        },
        {
