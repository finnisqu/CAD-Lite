   (function(){
    function init(){
      ...
      function renderPlanNavigator(){
        ...
        opacity.onchange=()=>{scheduleSave();pushHistory();};
        ...
        gray.onchange=()=>{plan.grayscale=gray.checked;draw();scheduleSave();pushHistory();};
    ...
    window.addEventListener('keydown', (e) => {
      ...
      planVisibilityViewCheck=addLayoutViewToggle('Floor Plan',()=>!!currentPlan()?.visible,visible=>{
        const plan=currentPlan();
