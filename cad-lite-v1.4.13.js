    ...
    pushHistory();
      ...
      function updateInspector(){
        ...
        if(sinksMountEl){
          ...
          sinkCenterlineInspectorEye.className='lc-btn ghost lc-iconbtn lc-head-eye lc-inspector-eye lc-sinks-dims-eye';
        ...
        if(seamHead&&seamArrow){
          ...
          seamVisibilityInspectorEye.className='lc-btn ghost lc-iconbtn lc-head-eye lc-inspector-eye lc-seams-eye';
