   (function(){
    ...
    window.addEventListener('keydown', (e) => {
        ...
        function snapshotState(){
          try{
            return JSON.stringify({
              ...
              showGrid: !!state.showGrid, showDims: !!state.showDims, showManualDims: !!state.showManualDims, showEdgeProfiles: !!state.showEdgeProfiles, showNotes: !!state.showNotes, showLabels: !!state.showLabels, showLabelDims: !!state.showLabelDims,
     ...
     // ===== General helpers (also used for rounding/inputs) =====
      ...
      // Round display to nearest 1/16" and reduce the resulting fraction.
