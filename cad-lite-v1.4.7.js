   (function(){
    ...
    window.addEventListener('keydown', (e) => {
      ...
      viewEdgeLabelSelect=addViewSelect('Edge Labels',[
        ['off','Off'],
        ['text','Text'],
        ['symbol','Symbols']
      ],value=>{
        if(value==='off'){
          state.showEdgeProfiles=false;
        }else{
          state.showEdgeProfiles=true;
          state.edgeLabelMode=value==='symbol'?'symbol':'text';
        }
        saveCurrentWorkspaceViewState?.();
      ...
      function syncViewMenuUI(){
        ...
        if(viewEdgeLabelSelect)viewEdgeLabelSelect.value=!state.showEdgeProfiles?'off':(state.edgeLabelMode==='symbol'?'symbol':'text');
