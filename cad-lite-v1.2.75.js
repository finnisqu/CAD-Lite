        ...
        function snapshotState(){
          try{
            return JSON.stringify({
              ...
              showGrid: !!state.showGrid, showDims: !!state.showDims, showManualDims: !!state.showManualDims, showEdgeProfiles: !!state.showEdgeProfiles, showNotes: !!state.showNotes, showLabels: !!state.showLabels,
...
if(btnAddLayout){
  btnAddLayout.onclick = ()=>{
    ...
    pushHistory();
      ...
      svg.addEventListener('pointermove',e=>{
        const cursor=activeToolCursor();
        if(cursor && e.target instanceof Element)e.target.style.setProperty('cursor',cursor,'important');
      },true);
      ...
      svg.addEventListener('pointermove',e=>{
        ...
        if(!mode||!start){if(toolPreview){toolPreview=null;draw();}return;}
