  ...
  "pieces": [
    ...
    { "id": "ycid73l", "name": "Backsplash", "w": 4, "h": 22.5, "x": 159, "y": 10, "rotation": 0, "color": "#d5f0f0", "layer": 8, "rTL": false, "rTR": false, "rBL": false, "rBR": false, "sinks": [] }
      ...
      if(overlayListEl){
        ...
        overlaysCard.append(head,overlayListEl);

        let overlaysOpen=false;
        const syncOverlaysOpen=()=>{
          if(overlaysOpen)overlayListEl.style.removeProperty('display');
          else overlayListEl.style.setProperty('display','none','important');
