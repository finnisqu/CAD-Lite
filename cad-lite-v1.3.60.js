   (function(){
    ...
    window.addEventListener('keydown', (e) => {
      ...
      function applyThemePreference(mode,{persist=true}={}){
        ...
        if(viewThemeSelect)viewThemeSelect.value=themeMode;
        if(persist){
      ...
      viewThemeSelect=addViewSelect('Mode',[
        ['light','Light'],
        ['dark','Dark'],
        ['system','System']
      ],value=>{
      ...
      viewThemeSelect.value=themeMode;
      });
        ...
        function snapshotState(){
          try{
            return JSON.stringify({
              ...
              showGrid: !!state.showGrid, showDims: !!state.showDims, showSinkCenterlines: !!state.showSinkCenterlines, showManualDims: !!state.showManualDims, showEdgeProfiles: !!state.showEdgeProfiles, showPieceFills: !!state.showPieceFills, showNotes: !!state.showNotes, showLines: !!state.showLines, showLabels: !!state.showLabels, showLabelDims: !!state.showLabelDims, dimPrecision: state.dimPrecision, dimFormat: state.dimFormat,
