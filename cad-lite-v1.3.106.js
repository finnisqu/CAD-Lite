    ...
    pushHistory();
      ...
      function renderAnnotationInspector(){
        ...
        if(note){
          ...
          formatRow.className='lc-note-format-row';
          ...
          alignGroup.className='lc-note-align-group';
          [
            ['left','L','Align left'],
          ...
          const formatMain=document.createElement('div');
          formatMain.className='lc-note-format-main';
          formatMain.append(size,boldBtn,italicBtn,alignGroup);

          const formatExtra=document.createElement('div');
          formatExtra.className='lc-note-format-extra';
          const colorGroup=document.createElement('div');
          colorGroup.className='lc-note-color-group';
          const colorLabel=document.createElement('span');
          colorLabel.textContent='Color';
          colorGroup.append(colorLabel,textColor);
          formatExtra.append(colorGroup,haloBtn);

          formatRow.append(formatMain,formatExtra);
          body.appendChild(inspectorField('Format',formatRow));
          ...
          resetRotation.className='lc-btn ghost sm lc-note-rotation-btn';
          ...
          const quarterTurn=document.createElement('button');
          quarterTurn.type='button';
          quarterTurn.className='lc-btn ghost sm lc-note-rotation-btn';
          quarterTurn.textContent='+90°';
          quarterTurn.title='Rotate note 90° clockwise';
          quarterTurn.onclick=()=>{
            note.rotation=normalizeNoteRotation(noteTextFormat(note).rotation+90);
            draw();scheduleSave();pushHistory();updateInspector();
          };

          rotationControl.append(rotationInput,degreeMark,resetRotation,quarterTurn);
          body.appendChild(inspectorField('Rotation',rotationControl));
