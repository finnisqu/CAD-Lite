  ...
  btnAddLayout.onclick = ()=>{
    ...
    pushHistory();
      ...
      function renderOverlayInspector(){
        ...
        body.appendChild(inspectorGroupTitle('Size','size'));
        ...
        body.appendChild(inspectorGroupTitle('Position','position'));
        ...
        body.appendChild(inspectorGroupTitle('Display','display'));
      ...
      function renderAnnotationInspector(){
        ...
        if(d){
          ...
          body.appendChild(inspectorGroupTitle('Geometry','geometry'));
          ...
          body.appendChild(inspectorGroupTitle('Label','label'));
        ...
        if(lineObj){
          ...
          body.appendChild(inspectorGroupTitle('Appearance','appearance'));
        ...
        if(note){
          ...
          typographyRow.append(sizeGroup.group,styleGroup.group,colorGroup.group,haloGroup.group);
