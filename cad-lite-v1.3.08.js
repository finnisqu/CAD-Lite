   (function(){
    ...
    window.addEventListener('keydown', (e) => {
      ...
      const btnShowLines=document.createElement('button');
      btnShowLines.className='lc-btn alt big';btnShowLines.type='button';btnShowLines.id='lc-toggle-lines';
      if(showNotesHost)showNotesHost.appendChild(btnShowLines);
      function syncShowLinesUI(){
        btnShowLines.textContent=state.showLines?'Hide Lines':'Show Lines';
        btnShowLines.classList.toggle('alt',!!state.showLines);
        btnShowLines.classList.toggle('ghost',!state.showLines);
      }
      btnShowLines.onclick=()=>{
        ...
        function snapshotState(){
          try{
            return JSON.stringify({
              ...
              showGrid: !!state.showGrid, showDims: !!state.showDims, showManualDims: !!state.showManualDims, showEdgeProfiles: !!state.showEdgeProfiles, showNotes: !!state.showNotes, showLines: !!state.showLines, showLabels: !!state.showLabels, showLabelDims: !!state.showLabelDims, dimPrecision: state.dimPrecision, dimFormat: state.dimFormat,
