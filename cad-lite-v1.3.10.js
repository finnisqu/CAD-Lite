   (function(){
    ...
    window.addEventListener('keydown', (e) => {
      ...
      function syncViewMenuUI(){
        ...
        // earlier in init, while the Notes/Dimensions/Lines eye buttons are
        // wired later. syncTopBar() synchronizes both once initialization is complete.
      ...
      [togGrid,togDims,togManualDims,togLabels,document.getElementById('lc-toggle-edges')].forEach(hideToolbarControl);
  ...
  "pieces": [
    ...
    { "id": "ycid73l", "name": "Backsplash", "w": 4, "h": 22.5, "x": 159, "y": 10, "rotation": 0, "color": "#d5f0f0", "layer": 8, "rTL": false, "rTR": false, "rBL": false, "rBR": false, "sinks": [] }
      ...
      function makeListCardToggle(listEl,label,visibilityKey){
      ...
      makeListCardToggle(dimList,'Dimensions','showManualDims');
      makeListCardToggle(noteList,'Notes','showNotes');
      makeListCardToggle(lineList,'Lines','showLines');
      syncListVisibilityEyes();
