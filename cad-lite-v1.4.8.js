  ...
  btnAddLayout.onclick = ()=>{
    ...
    pushHistory();
      ...
      function updateInspector(){
        ...
        labelColorRow.className='lc-label lc-piece-label-color-row';
        ...
        labelColor.className='lc-input lc-piece-label-color-input';
        labelColor.title='Piece label color';
        labelColor.setAttribute('aria-label','Piece label color');
        ...
        syncLabelColorControls();
        labelColorControls.append(labelColor,labelColorAuto);
